...
V3.0.6 has explicit release gates for both the Python compiler and dbt package.
...
`incremental` materialization is deliberately not advertised in V3.0.6 until watermark and merge semantics are fully declarative.
...
V3.0.6 therefore provides a real companion dbt package called:
...
| First public release details                        | [V3.0.6 release notes](V3.0.6_RELEASE_NOTES.md) |

---

# Publishing and consuming V3.0.6
