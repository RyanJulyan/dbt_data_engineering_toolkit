...
The `det` CLI turns the controlled V4.1.1 official-ODCS Excel superset into
...
V4.1.1 makes the visible official `Quality` sheet authoritative, preserves
...
```bash
python -m pip install dbt-data-engineering-toolkit-compiler==4.1.1
```
