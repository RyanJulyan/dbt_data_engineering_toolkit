...
The `det` CLI turns the controlled V3.0.7 official-ODCS Excel superset into
...
V3.0.7 makes the visible official `Quality` sheet authoritative, preserves
...
```bash
python -m pip install dbt-data-engineering-toolkit-compiler==3.0.7
```
