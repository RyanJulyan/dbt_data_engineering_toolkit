...
The `det` CLI turns the controlled V4.0.1 official-ODCS Excel superset into
...
V4.0.1 makes the visible official `Quality` sheet authoritative, preserves
...
```bash
python -m pip install dbt-data-engineering-toolkit-compiler==4.0.1
```
