...
The `det` CLI turns the controlled V3.1.0 official-ODCS Excel superset into
...
V3.1.0 makes the visible official `Quality` sheet authoritative, preserves
...
```bash
python -m pip install dbt-data-engineering-toolkit-compiler==3.1.0
```
